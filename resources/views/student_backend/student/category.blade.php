                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-md-6 col-sm-12 my-3">
                                        <div id="cardspace"  class="card component-card_2" onclick="loadVideo(1)"  data-toggle="modal" data-target="#exampleModalCenter">
                                            ...
                                            <div class="card-body">
                                                <center><h5 class="card-title">Scope and importance of biology</h5></center>
                                    ...
                                    <div class="col-lg-4 col-md-6 col-sm-12 my-3">
                                        <div id="cardspace"  class="card component-card_2" onclick="loadVideo(2)" data-toggle="modal" data-target="#exampleModalCenter">
                                            ...
                                            <div class="card-body">
                                                <center><h5 class="card-title">Issues pertaining  to biology</h5></center>
                                    ...
                                    <div class="col-lg-4 col-md-6 col-sm-12 my-3">
                                        <div id="cardspace"  class="card component-card_2" data-toggle="modal" data-target="#exampleModalCenter">
                                            ...
                                            <div class="card-body">
                                                <center><h5 class="card-title">Diversity of organisms</h5></center>
                                    ...
                                    <div id="cardspace"  class="card component-card_2" data-toggle="modal" data-target="#exampleModalCenter">
                                        ...
                                        <div class="card-body">
                                            <center><h5 class="card-title">Characteristics of organisms</h5></center>
